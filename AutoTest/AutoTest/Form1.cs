...
>>>>>>> d308a570de5c4f0e44a609dc813dda8c09b55e4c
        ...
        #region -- 跑Schedule的指令集 --
         public int sRepeat = 0, stime = 0, SysDelay = 0;
        ...
        */
        ...
        //Select and copy log from textBox1
        ...
        FormReleaseTest FormReleaseTest;

        private void button_ReleaseTest_Click(object sender, EventArgs e)
        {
            FormReleaseTest = new FormReleaseTest();
            FormReleaseTest.comboBox_TestItem.SelectedValueChanged += ComboBox_TestItem_SelectedValueChanged;
            FormReleaseTest.Owner = this;
            if (Global.FormReleaseTest == false)
            {
                FormReleaseTest.Show();
            }
        ...
        private void FormReleaseTest_Click(object sender, EventArgs e)
        {
            throw new NotImplementedException();
        }
    }
    ...
    public class Global//全域變數//
    {
        ...
        public static string keyPath = Application.StartupPath + "\\key_cmd.ini";
        ...
        public static bool FormReleaseTest = false;
